...
test_expect_success "subdomain gw: redirect dir listing to URL with traling slash" '
...
test_expect_success "dnslink gw: redirect dir listing to URL with traling slash" '
